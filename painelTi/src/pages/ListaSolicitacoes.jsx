                ...
                {solicitacoes.length === 0 ? (
                    ...
                    >
                        {solicitacoes.map((solicitacao, index) => (
                            <div key={solicitacao.id} className="max-w-[350px] p-6 mr-2 bg-white text-black border border-gray-200 rounded-xl shadow-sm hover:shadow-md transition-shadow duration-200">
                                    ...
                                    <div className="flex flex-col gap-2 mt-4">
                                        <div className='flex flex-row gap-2'>
                                            <div className='w-full'>
                                                <button
                                                    className={`w-full mr-2 bg-red-500 hover:bg-red-600 text-white font-bold py-2 px-4 rounded ${solicitacao.status === 'Pendente' ? 'ring-2' : ''}`}
                                            ...
                                            <div className='w-full'>
                                                <button
                                                    className={`w-full bg-yellow-500 hover:bg-yellow-600 text-white font-bold py-2 px-4 rounded ${solicitacao.status === 'Progresso' ? 'ring-2' : ''}`}
                                        ...
                                        <div className='flex flex-row gap-2'>
                                            <div className='w-full'>
                                                <button
                                                    className={`w-full mr-2 bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded ${solicitacao.status === 'Enviado' ? 'ring-2' : ''}`}
                                                    onClick={() => updateStatus(solicitacao.id, 'Enviado')}
                                                >
                                                    Enviado
                                                </button>
                                            </div>
                                            <div className='w-full'>
                                                <button
                                                    className={`w-full bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-4 rounded ${solicitacao.status === 'Concluído' ? 'ring-2' : ''}`}
